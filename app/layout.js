      ...
      <body className={`${inter.className} min-h-screen flex flex-col`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex space-x-8">
                ...
                <Link href="/products" className="text-slate-600 hover:text-blue-600">Products</Link>
                <Link href="/about" className="text-slate-600 hover:text-blue-600">About Us</Link>
              </div>
        ...
        <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-white text-lg font-bold mb-4">HJMR Industries</h3>
              <p className="text-sm">Simplifying hygiene with durable cleaning solutions.</p>
            </div>
            <div>
              <h3 className="text-white text-lg font-bold mb-4">Contact</h3>
              <p className="text-sm">Vasai, Palghar, Maharashtra</p>
              <p className="text-sm">+91 98XXX XXXXX</p>
              <p className="text-sm">contact@hjmr.com</p>
            </div>
            <div>
              <h3 className="text-white text-lg font-bold mb-4">Statutory</h3>
              <p className="text-xs">GST: 27AAPFH4059M1ZQ</p>
          ...
          <div className="max-w-7xl mx-auto px-4 border-t border-slate-800 pt-6 flex justify-between text-xs">
            <p>© {new Date().getFullYear()} HJMR Industries</p>
            <a
              href="https://dyash2.github.io/portfolio/"
              target="_blank"
